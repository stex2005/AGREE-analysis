...
%% Start and stop
load('agree_esmacat_transparent.mat');
...
%     ylabel('Velocity [rad/s]','Interpreter','LaTex')
    ...
    rectangle('Position',[round(t(2)) -10 round(t(3))-round(t(2)) 20],'FaceColor',[0.6510    0.6510    0.6510 0.2],'EdgeColor',[  0   0   0   0.2])
    rectangle('Position',[round(t(4)) -10 round(t(5))-round(t(4)) 20],'FaceColor',[0.6510    0.6510    0.6510 0.2],'EdgeColor',[  0   0   0   0.2])
    rectangle('Position',[round(t(6)) -10 round(t(7))-round(t(6)) 20],'FaceColor',[0.6510    0.6510    0.6510 0.2],'EdgeColor',[  0   0   0   0.2])
    rectangle('Position',[round(t(8)) -10 round(t(9))-round(t(8)) 20],'FaceColor',[0.6510    0.6510    0.6510 0.2],'EdgeColor',[  0   0   0   0.2])
   ...
   subplot(2,2,4);
    ...
    xlim([0 65])
     ...
     title('J4 - Elbow flexion/extension','Interpreter','LaTex')
         legend('Measured Position','Measured Torque','Anti-gravity Torque','Interpreter','LaTeX','Location','South');
